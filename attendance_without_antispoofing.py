...
def login():
            ...
            if row == None:
                ...
                def manage_employee():
                    try:
                        ...
                        bg_photo = PhotoImage(file = "Photos/background.png", master = first)
                ...
                def train(): 
                    try:
                        ...
                        img3= PhotoImage(file = "Photos/background.png", master = second)
    ...
    ######################################### Function to recognize the face
                ...
                def face_embedding():
                    ...
                    img1= PhotoImage(file = "Photos/background.png", master = fe)
                ...
                bg_image = PhotoImage(file = "Photos/background.png", master = attendance)
