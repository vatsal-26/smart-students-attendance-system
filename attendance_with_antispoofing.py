...
def login():
            ...
            if row == None:
                ...
                def manage_employee():
                    try:
                        ...
                        bg_photo = PhotoImage(file = "Photos/white.png", master = first)
                        background_pic = Label(first, image = bg_photo)
                        background_pic.pack()
                        first.title("Manage Student Attendance")
                        print("Hello Admin")
                        photo14 = PhotoImage(file = "Photos/header4.png", master = first)
                        face = Label(first, image = photo14,font = ("times new roman", 30, "bold"))
                        face.place (x = 0, y = 0,relwidth = 1)
                        main = Label(first, bg = "cyan", borderwidth = 1).pack()
                        def back():
                            first.destroy() 
                                        ...
                                        if (re.search('^[9]\d{9}$', contact_var.get())):
                                            ...
                                            if(re.search(regex, address_var.get())):
                                                ...
                                                if not os.path.exists(input_directory):
                                                    ...
                                                    cur1 = conn.cursor()
                                                    cur1.execute("insert into attendance(roll_no,fname,gender,contact_no,email_address,date_of_join) VALUES (%s,%s,%s,%s,%s,%s)", (
                                                                                                                                                                                post_var.get(),
                                                                                                                                                                                fname_var.get(),
                                                                                                                                                                                gender_var.get(),
                                                                                                                                                                                contact_var.get(),
                                                    ...
                                                    conn.commit()
                                                    cur2 = conn.cursor()
                                                    cur2.execute("select stdid from attendance where fname=%s ",(name))
                                            ...
                                            if(re.search(regex, address_var.get())):
                                                ...
                                                if id in staff_ids:
                                                    ...
                                                    if (q == True):
                                                        ...
                                                        video_capture.release()
                                                        cv2.destroyAllWindows()
                                                        cur.execute("update attendance set roll_no = %s, fname = %s, gender = %s, contact_no = %s, email_address = %s where stdid = %s", (                                                               
                                                                                                    post_var.get(),
                                                                                                    fname_var.get(),
                                                                                                    gender_var.get(),
                                                                                                    contact_var.get(),
                    ...
                    ###################### To delete the items #########################
                        def delete():
                            ...
                            if post_var.get() == "" or fname_var.get() == "" or gender_var.get() ==  "" or contact_var.get() == "" or address_var.get() == "":
                                ...
                                try:
                                    input_name = fname_var.get() + "_" + stdid_var.get()
                                    staff_input = os.path.join(dataset_dir,input_name)
                                    if not os.path.exists(staff_input):
                                        cur.execute("delete from attendance where stdid = %s",stdid_var.get())
                                    else:
                                        cur.execute("delete from attendance where stdid = %s",stdid_var.get())
                    ...
                    ################################################## Employee Management form ###############################
                        f2 = Frame(first, bg = "white",borderwidth = "3", relief = SUNKEN, height = 600, width = 420)
                        titles = Label(f2, text = "Manage Student" ,bg = "white", font = ("Italic", 20, "bold")).place(x = 90, y = 30)
                        id = Label(f2, text = "Student ID", bg = "white", font = ("italic",13, "bold")).place(x = 35, y = 100 )
                        E1 = Entry(f2,state="disabled", width = 20, textvariable = stdid_var,  font = ("italic",13, "bold") ).place(x = 180  , y = 100)
                        post = Label(f2, text = "Roll No", bg = "white",  font = ("italic",13, "bold")).place(x = 35, y = 150 )
                        E2 = Entry(f2, width = 20, textvariable = post_var,  font = ("italic",13, "bold")).place(x =180, y = 150)
                        name = Label(f2, text = "Full Name", bg = "white", font = ("italic",13, "bold")).place(x =35, y = 200)
                        E3 = Entry(f2, width = 20, textvariable = fname_var , font = ("italic",12, "bold")).place(x = 180, y = 200)
                        gender = Label(f2, text = "Gender", bg = "white", font = ("italic",12, "bold")).place(x = 35, y= 250)
                        E7 = Combobox(f2, textvariable = gender_var , values = ["Male","Female","Others"], state = "readonly",  font = ("italic",11, "bold")).place(x = 180, y = 250)
                        no = Label(f2, text = "Contact.No", bg = "white", font = ("italic",12, "bold")  ).place(x = 35, y = 300)
                        E4 = Entry(f2, width = 20, textvariable = contact_var , font = ("italic",12, "bold") ).place(x = 180, y = 300 ) 
                        address = Label(f2, text = " Email Address", bg = "white", font = ("italic",12, "bold")).place(x = 35, y = 350)
                        ...
                        btn1 = Button(f3, text = "Add", bg = "white", height = "1", width = "7",command = add_employee, font = ("Times new Roman", 14 , "bold")).place(x = 10, y = 10)
                        btn2 = Button(f3, text = "Update", bg = "white", height = "1", width = "7", command = update, font = ("Times new Roman", 14 , "bold")).place(x = 105, y = 10)
                        btn3 = Button(f3, text = "Delete", bg = "white",  height = "1", width = "7", command = delete,  font = ("Times new Roman", 14 , "bold")).place(x = 205, y = 10)
                        btn4 = Button(f3, text = "Clear", bg = "white", height = "1", width = "7", command = clear, font = ("Times new Roman", 14 , "bold")).place(x = 305, y = 10)
                        ...
                        f3.place(x = 20, y = 550)
                    ################################################################################### Large Frame
                        f4 = Frame(first, height = 600, width = 900, bg = "white", borderwidth = "3", relief = SUNKEN)
                        f4.place(x = 440, y = 90)
                        l1 = Label(first, text = "Search By:",font = ("times new roman", 18 ,"bold"),bg = "white", fg = "black").place(x = 460, y = 100 )
                        c1 = Combobox(first, textvariable = search_from, values = ["stdid","fname","roll_no"], state = "readonly", width = "25").place(x = 580, y = 109)
                    ...
                    ################################################################################## Table frame
                        ...
                        table1 = Treeview(f5, columns = ("stdid","post", "fname","gender","contact.no","address","DOJ"), xscrollcommand = scroll_x.set, yscrollcommand = scroll_y.set)
                        scroll_x.pack(side = BOTTOM, fill = X )
                        scroll_y.pack(side = RIGHT, fill = Y)
                        scroll_x.config(command = table1.xview)
                        scroll_y.config(command = table1.yview)
                        table1.heading("stdid", text ="Student ID")
                        table1.heading("fname", text= "Full Name")
                        table1.heading('post', text = "Roll No")
                ...
                def train(): 
                    try:
                        ...
                        img3= PhotoImage(file = "Photos/white.png", master = second)
                        backgrd = Label(second, image = img3)
                        backgrd.pack()

                        photo11 = PhotoImage(file = "Photos/header.png", master = second)
                        train_title = Label(second, image = photo11, fg = 'white', height = 40, width= 550, font = ("times new roman", 20, "bold"))
                        train_title.place(x = 0,y = 0, relwidth = 1)
                        img4 = PhotoImage(file = "Photos/sample1.png")
                        ...
                        btn = Button(second, text = "Start Training", fg = 'black',font = ("Times new roman", 20, "bold"), command = progress, bg = "white" )
    ...
    ######################################### Function to recognize the face
                ...
                def change():
                    ...
                    account_frame.pack()
                    photo15 = PhotoImage(file = "Photos/header6.png", master = account_frame)
                    title = Label(account_frame, image = photo15,font = ("times new roman", 30, "bold"))    
                    ...
                    logo_icon = PhotoImage(file = 'Photos/logo1.png',master = account)
                    admin_logo = Label(account_frame, image= logo_icon, bg = 'white').place( y = 70, relwidth = 1)
                    pass_icon = PhotoImage(file = 'Photos/password1.png', master = account)
                    ...
                    user_icon = PhotoImage(file = 'Photos/user1.png', master = account)
                    ...
                    btn = Button(account_frame, text = 'Reset', font = ('times new roman', 14, 'bold'), width = 10 , bg = 'white', command = user_change, relief = GROOVE).place(x = 240, y = 380 )
                    account.mainloop()   
                ...
                def report():
                    ...
                    photo13 = PhotoImage(file = "Photos/header3.png", master = report)
                    title_label = Label(report, image = photo13,font = ("times new roman", 30, "bold"))
                    title_label.place (x = 0, y = 0,relwidth = 1)
                    title_label.pack()
                    def back():
                        report.destroy()
                    backbtn = Button(report, text = 'Back' , fg = 'black', bg = 'white', font = ("Times New Roman", 20 ,"bold"), relief = RIDGE, command = back).place(x = 1250, y = 0)
                ...
                def face_embedding():
                    ...
                    img1= PhotoImage(file = "Photos/white.png", master = fe)
                    backgrd = Label(fe, image = img1)
                    backgrd.pack()

                    photo12 = PhotoImage(file = "Photos/header2.png", master = fe)
                    embed_title = Label(fe, image = photo12,font = ("times new roman", 30, "bold"))
                    embed_title.place(x = 0,y = 0, relwidth = 1)
                    img2 = PhotoImage(file = "Photos/sample1.png")
                    embed_img2 = Label(fe, image = img2)
                    embed_img2.place(x = 390, y =150)
                    staff_details = embedding_obj.get_staff_details()
                    embeddings_model_file = os.path.join(root_dir,"models/embeddings.pickle")
                    if not os.path.exists(embeddings_model_file):
                        ...
                        def start_extracting_embedding(pixels):   
                            ...
                            data = {"paths":image_paths, "names":names,"face_ids":face_ids, "imagstdids":image_ids,"embeddings":embeddings}
                        ...
                        def back():
                            fe.destroy()
                        backbtn = Button(fe, text = 'Back',fg = 'black', bg = 'white', font = ('times new roman', 18 , 'bold'), height = 1, width = 7, command = back).place(x = 1260, y = 3)
                        l = len(face_pixels)
                        percent = StringVar()
                        text = StringVar()  
                        ...
                        btn = Button(fe,text="Start Extracting Embeddings",fg = 'white', font = ("Times new roman", 20, "bold"),command=lambda: start_extracting_embedding(pixels=face_pixels),bg="white")
                        ...
                        if data != None:
                            ...
                            def start_extracting_embedding(pixels):   
                                ...
                                for (i,face_pixel) in enumerate(face_pixels):
                                    ...
                                    new_embedding = embedding.reshape(-1)
                                    embeddings.append(new_embedding)
                                new_data = {"paths":image_paths, "names":names,"face_ids":face_ids, "imagstdids":image_ids,"embeddings":embeddings}
                                combined_data = {"paths":[],"names":[],"face_ids":[],"imagstdids":[],"embeddings":[]}
                                ...
                                combined_data["imagstdids"] = old_data["imagstdids"] + new_data["imagstdids"]
                            ...
                            def back():
                                fe.destroy()
                            backbtn = Button(fe, text = 'Back', fg = 'black', bg = 'white', font = ('times new roman', 18 , 'bold'), command = back).place(x = 1250, y = 1)
                            l = len(face_pixels)
                            percent = StringVar()
                            text = StringVar()  
                            pgbar = Progressbar(fe,length=500,mode='determinate',maximum=l,value=0,orient=HORIZONTAL)
                            ...
                            textlabel = Label(fe,textvariable=text,font=("Times new roman", 16, "bold")) 
                            textlabel.place(x=475,y=500)  
                            btn = Button(fe,text="Start Extracting Embeddings",fg = 'black', font = ("Times new roman", 20, "bold"),command=lambda: start_extracting_embedding(pixels=face_pixels),bg="white")
                            btn.place(x = 450, y = 570)
                            fe.mainloop()
                        else:
                ...
                bg_image = PhotoImage(file = "Photos/white.png", master = attendance)
                ...
                photo10 = PhotoImage(file = "Photos/header1.png", master = attendance)
                topic = Label(attendance, image = photo10 , fg = "yellow", padx = 15, pady = 15, height = 40, width= 500, font = ("Times New Roman", 20, "bold") ,borderwidth = 5, relief = RIDGE)
                topic.place (x = 0, y = 0,relwidth = 1)
                # faceslider()
                # faceslidercolor()

                photo1 = PhotoImage(file = "Photos/add-user.png", master = attendance)
                ...
                photo2 = PhotoImage(file = "Photos/attendant-list.png",  master = attendance)
                ...
                B2.place(x = 20, y = 400)
                photo3 = PhotoImage(file = "Photos/train_data.png",  master = attendance)
                ...
                photo4 = PhotoImage(file = "Photos/exit.png",  master = attendance )
                ...
                photo5 = PhotoImage(file = "Photos/file.png" ,  master = attendance)
                ...
                photo7 = PhotoImage(file = "Photos/settings.png", master = attendance)
                ...
                B7.place(x = 700, y = 100)
                photo8 = PhotoImage(file = "Photos/extraction.png", master = attendance)
...
bg_icon = PhotoImage(file = "Photos/white.png", master = face)
background_image = Label(face, image = bg_icon)
background_image.pack()

photo14 = PhotoImage(file = "Photos/header4.png", master = face)
title = Label(face, image = photo14,font = ("times new roman", 30, "bold"))
title.place (x = 0, y = 0,relwidth = 1)

clock = Label(face , font = ("times",20,"bold"), bg = "white", relief = GROOVE)
clock.place(x = 1000, y= 600)
tick()
login_frame= Frame(face, bg = "white" )
login_frame.place(x = 400, y = 200)
logo_icon = PhotoImage(file = "Photos/logo1.png", master= login_frame)
logo_image = Label(login_frame, image = logo_icon, bd = 0 ).grid( row = 0, columnspan = 3 , pady = 40, padx= 40)
user_icon = PhotoImage(file = "Photos/user1.png", master = login_frame)
password_icon = PhotoImage(file = "Photos/password1.png", master = login_frame)
...
submit_btn = Button(login_frame, text = "Log In",width = 10, activebackground = "blue", activeforeground = "white", command = login , font = ("times new roman", 20, "bold"),relief = GROOVE, bg = "white").grid(row = 3, column = 1, pady =20, padx = 20) 
face.mainloop()            